"""
Django settings for blacar project.
...
SECRET_KEY = 'django-insecure-w%myrkppy45#=epgpg2!^@q784$^z3b)v&^e$y=k0rfh!7*&)g'
...
WSGI_APPLICATION = 'blacar.wsgi.application'
...
DEFAULT_FROM_EMAIL = "blacar@blacar.com"
